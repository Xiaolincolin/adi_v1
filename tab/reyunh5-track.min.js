(function() {
    ...
    var a = {
        ...
        str2binl: function(t) {
            ...
            for (var n = 0; n < t.length * this.chrsz; n += this.chrsz)
                i[n >> 5] |= (t.charCodeAt(n / this.chrsz) & e) << n % 32;
            return i
        },
    ...
    var _ = {
        ...
        getSessionId: function() {
            var t = _.getItem("ryh5_sessionid");
            if (t && t != "") {
                return t
            }
            ...
            for (var s = 0; s < e.length; s++) {
                var r = e[s]
                  , h = r.split("=");
                if (h[0].trim() === "JSESSIONID") {
                    n = h[1];
                    break
                }
            }
            if (n == "") {
                n = a.getMD5Str(navigator.userAgent + String((new Date).getTime() + Math.random()));
                _.setItem("ryh5_sessionid", n)
            } else {
                n = a.getMD5Str(n + String((new Date).getTime() + Math.random()))
            }
            return n
        },
        getItem: function(i) {
    ...
    var t = new function() {
        ...
        var c = function() {
            var i = function() {
                var t = _.getCommonParams();
                _.locationurl = t.context._url = document.location.href;
                t.what = "pageview";
                _.send("event", t)
            };
            if (_.locationurl == "") {
        ...
        this.init = function(t) {
            _.setItem("ryh5_appid", t);
            var i = window.location.href
              , e = i.substring(i.indexOf("?") + 1)
              , n = e.split("&");
            var s = _.getItem("ryh5_cid")
              , r = _.getItem("ryh5_campid")
              , h = _.getItem("ryh5_sessionid");
            s = s == "" ? "-1" : s;
            r = r == "" ? "_default_" : r;
            h = h == "" ? _.getSessionId() : h;
            ...
            _.setItem("ryh5_cid", s);
            _.setItem("ryh5_campid", r);
            _.setItem("ryh5_sessionid", h);
            c();
        ...
        this.register = function(t, i) {
            var e = _.getCommonParams(i);
            e.who = t;
            _.send("register", e)
        }
        ;
        this.loggedin = function(t, i) {
            var e = _.getCommonParams(i);
            e.who = t;
            _.setItem("ryh5_usid", t);
            _.send("loggedin", e);
            c()
        }
        ;
        this.download = function(t) {
            var i = _.getCommonParams(t);
            i.what = "download";
            _.send("event", i)
        }
        ;
        ...
        ;
        this.payment = function(t, i, e, n, s) {
            var r = _.getCommonParams(s);
            r.context._transactionid = t;
            r.context._currencyamount = i;
            r.context._currencytype = e;
            r.context._paymenttype = n;
            _.send("payment", r)
        }
        ;
        this.event = function(t, i) {
            var i = _.getCommonParams(i);
            i.what = t;
            _.send("event", i)
        }
    }
